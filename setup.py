...
setup(name='FormAlchemy',
      ...
      install_requires=['SQLAlchemy', 'Tempita', 'WebHelpers2>=2.0', 'WebOb', 'MarkupSafe', 'six'],
      extras_require={'test': ['nose', 'coverage', 'beautifulsoup4', 'mako', 'Genshi', 'webtest', 'doctest-ignore-unicode']},
